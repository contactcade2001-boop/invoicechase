                ...
                <div className="rounded-xl bg-white p-4 ring-1 ring-stone-200">
                  ...
                  {!xeroEnabled ? (
                    ...
                    <a
                      ...
                      className="mt-3 inline-flex items-center gap-1.5 rounded-md bg-white px-3 py-1.5 text-xs font-semibold text-stone-700 ring-1 ring-inset ring-stone-300 hover:bg-slate-100"
                    >
                      <XeroLogo size={14} />
                      Connect Xero
                    </a>
                ...
                <div className="mt-3 grid gap-3 sm:grid-cols-2">
                  ...
                  <div className="rounded-xl bg-white p-4 ring-1 ring-stone-200">
                    ...
                    {!hcpEnabled ? (
                      ...
                      <>
                        <p className="mt-2 text-xs text-stone-600">Connected</p>
                        <form
