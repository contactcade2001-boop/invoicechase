                ...
                <div className="rounded-xl bg-stone-950 p-4 ring-1 ring-stone-800">
                  ...
                  {!xeroEnabled ? (
                    ...
                    <a
                      ...
                      className="mt-3 inline-flex items-center gap-1.5 rounded-md bg-stone-900/70 px-3 py-1.5 text-xs font-semibold text-stone-300 ring-1 ring-inset ring-stone-700 hover:bg-slate-100"
                    >
                      <XeroLogo size={14} />
                      Connect Xero
                    </a>
                ...
                <div className="mt-3 grid gap-3 sm:grid-cols-2">
                  ...
                  <div className="rounded-xl bg-stone-950 p-4 ring-1 ring-stone-800">
                    ...
                    {!hcpEnabled ? (
                      ...
                      <>
                        <p className="mt-2 text-xs text-stone-400">Connected</p>
                        <form
