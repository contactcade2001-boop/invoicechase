            ...
            <>
              ...
              {googleOn ? (
                <a
                  ...
                  className="mt-6 inline-flex w-full items-center justify-center gap-2.5 rounded-md bg-white px-4 py-2.5 text-sm font-semibold text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 transition hover:bg-white hover:ring-slate-400 hover:shadow"
                >
                  <GoogleGlyph />
