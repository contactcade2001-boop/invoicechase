    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-3xl px-5 py-12 lg:px-6">
        ...
        <section className="mt-10">
          ...
          <div className="mt-3 overflow-hidden rounded-2xl bg-stone-900/70 ring-1 ring-stone-800">
            {services.map((s, i) => {
              ...
              return (
                <div
                  ...
                  className={`flex items-center gap-3 px-5 py-4 ${
                    i > 0 ? "border-t border-stone-800/60" : ""
                  }`}
                >
                  <span
                  ...
                  <span
                    className={`inline-flex items-center gap-1.5 rounded-full px-2 py-0.5 text-[11px] font-semibold ring-1 ring-inset ring-stone-800 ${style.bg} ${style.text}`}
                  >
                    {style.label}
                  </span>
                </div>
        ...
        <section className="mt-10">
          ...
          <div className="mt-3 space-y-3">
            {incidents.map((i) => (
              <article
                key={i.title}
                className="rounded-2xl bg-stone-900/70 p-5 ring-1 ring-stone-800"
              >
