          ...
          >
            <label className="block">
              ...
              <input
                ...
                className="mt-1 block rounded-md border-0 px-3 py-2 text-sm shadow-sm ring-1 ring-inset ring-stone-300 focus:ring-2 focus:ring-inset focus:ring-slate-900"
              />
            </label>
            <button
              type="submit"
