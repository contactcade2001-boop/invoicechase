            ...
            <div key={s} className="flex flex-1 items-center gap-3">
              ...
              <span
                className={`hidden text-xs font-semibold uppercase tracking-wider sm:inline ${
                  i === step ? "text-stone-900" : "text-stone-600"
                }`}
              >
                {s}
              </span>
        ...
        <section className="mt-10 rounded-2xl bg-white p-8 shadow-xl shadow-stone-900/5 ring-1 ring-stone-200">
              ...
              <div className="mt-6 space-y-4">
                <label className="block">
                  ...
                  <input
                    ...
                    className="mt-1.5 block w-full rounded-md border-0 px-3 py-2.5 text-stone-900 shadow-sm ring-1 ring-inset ring-stone-300 placeholder:text-stone-600 focus:ring-2 focus:ring-inset focus:ring-stone-900"
                  />
                </label>
                <label className="block">
                  <span className="text-xs font-semibold text-stone-700">
          ...
          <div className="mt-8 flex items-center justify-between border-t border-stone-100 pt-6">
            <button
              ...
              onClick={back}
              disabled={step === 0}
              className="inline-flex items-center gap-1.5 rounded-md px-3 py-2 text-sm font-medium text-stone-600 transition hover:bg-orange-700 hover:text-stone-900 disabled:cursor-not-allowed disabled:opacity-40"
            >
