  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className="relative inline-flex h-8 w-8 items-center justify-center rounded-md text-stone-500 transition hover:bg-orange-700 hover:text-stone-900"
      >
        ...
        <div className="absolute right-0 top-full z-30 mt-2 w-80 overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-stone-200">
          ...
          <ul className="max-h-96 divide-y divide-stone-100 overflow-y-auto">
            {notifs.map((n) => (
              <li
                key={n.id}
                className={`flex items-start gap-3 px-4 py-3 transition hover:bg-white ${
          ...
          <div className="border-t border-stone-100 bg-stone-50 px-4 py-2 text-center">
            <a
              href="/inbox"
