    ...
    <div className="space-y-5">
              ...
              >
                ...
                <div className="flex shrink-0 gap-1.5">
                  ...
                  <button
                    ...
                    disabled={pending}
                    className="inline-flex items-center gap-1 rounded-md bg-stone-900 px-2.5 py-1 text-[11px] font-semibold text-white transition hover:bg-stone-800 disabled:opacity-50"
                  >
                    Filed
                  </button>
                  <button
                    ...
                    disabled={pending}
                    className="inline-flex items-center gap-1 rounded-md px-2.5 py-1 text-[11px] font-medium text-stone-500 transition hover:bg-stone-100 hover:text-stone-900 disabled:opacity-50"
                  >
                    Dismiss
                  </button>
                </div>
      ...
      {showForm ? (
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-md bg-stone-900 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-stone-800"
        >
          <Plus className="h-3.5 w-3.5" />
          Track another job
        </button>
