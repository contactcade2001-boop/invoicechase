      ...
      {appts.length > 0 ? (
        <ul className="mt-3 space-y-2">
          {appts.map((a) => (
            <li
              key={a.id}
              className="flex items-start gap-2 rounded-md bg-white px-3 py-2 text-xs ring-1 ring-inset ring-stone-200"
            >
              ...
              <button
                ...
                onClick={() => cancel(a.id)}
                disabled={pending}
                className="rounded-md p-1 text-stone-600 transition hover:bg-orange-700 hover:text-stone-700 disabled:opacity-50"
                aria-label="Cancel"
              >
