      ...
      {list.map((i) => {
        ...
        return (
          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={pending}
                  className="inline-flex items-center gap-1.5 rounded-md bg-white px-3 py-1.5 text-xs font-medium text-stone-700 shadow-sm ring-1 ring-stone-300 transition hover:bg-stone-50 hover:ring-stone-400 disabled:opacity-50"
                >
                  <X className="h-3 w-3" />
                  Decline
                </button>
            ...
            <pre className="mt-4 whitespace-pre-wrap rounded-md bg-stone-50 px-4 py-3 font-sans text-sm leading-6 text-stone-700 ring-1 ring-inset ring-stone-200">
              {i.draftBody}
            </pre>
            {i.reason ? (
