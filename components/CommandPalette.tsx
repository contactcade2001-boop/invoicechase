  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between border-t border-stone-100 px-4 py-2 text-[10px] text-stone-400">
          <span className="inline-flex items-center gap-1.5">
            <kbd className="rounded border border-stone-200 bg-stone-50 px-1 font-mono">↑↓</kbd>
            navigate
            <kbd className="rounded border border-stone-200 bg-stone-50 px-1 font-mono">↵</kbd>
            select
          </span>
          <span className="inline-flex items-center gap-1">
            <kbd className="rounded border border-stone-200 bg-stone-50 px-1 font-mono">⌘K</kbd>
            anywhere
          </span>
        </div>
      </div>
