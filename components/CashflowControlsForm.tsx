...
export function CashflowControlsForm({ config }: { config: CashflowConfig }) {
  ...
  return (
    <div className="space-y-5">
      {saved ? (
        <div className="fixed right-6 top-20 z-10 inline-flex items-center gap-2 rounded-full bg-stone-900 px-3 py-1.5 text-xs font-semibold text-white shadow-lg">
...
function Preview({
  ...
  return (
    <div className="rounded-md bg-stone-50 px-3 py-2 text-xs ring-1 ring-inset ring-stone-200">
