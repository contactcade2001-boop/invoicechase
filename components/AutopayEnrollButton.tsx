          ...
          <div className="flex gap-1.5">
            {paused ? (
              ...
              <button
                ...
                disabled={busy}
                className="inline-flex items-center gap-1 rounded-md bg-white px-2.5 py-1 text-[11px] font-semibold text-stone-700 ring-1 ring-stone-300 transition hover:bg-stone-50 disabled:opacity-50"
              >
  ...
  if (!open) {
    return (
      <button
        ...
        className="group inline-flex items-center gap-2 rounded-md bg-stone-900 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-stone-800"
      >
    ...
    <div className="rounded-xl border border-stone-200 bg-white p-4">
      ...
      <div className="mt-4 flex gap-2">
        ...
        <button
          ...
          className="rounded-md px-3 py-2 text-xs font-medium text-stone-500 transition hover:bg-stone-100 hover:text-stone-900"
        >
          Cancel
        </button>
      </div>
