...
const STATUS_STYLES: Record<string, string> = {
  ...
  not_started: "bg-slate-100 text-stone-700 ring-stone-200",
};
  ...
  return (
    <div className="space-y-4">
      ...
      <a
        ...
        target="_blank"
        rel="noopener"
        className="inline-flex items-center gap-1 text-sm font-semibold text-stone-900 underline-offset-2 hover:underline"
      >
        Open Twilio console
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <label className="block">
          <span className="text-sm font-medium text-stone-700">EIN</span>
          <input
            type="text"
            value={v.businessEin}
            ...
            className="mt-1 block w-full rounded-md border-0 px-3 py-2 font-mono text-sm shadow-sm ring-1 ring-inset ring-stone-300 focus:ring-2 focus:ring-inset focus:ring-slate-900"
          />
        </label>
        <label className="block">
          <span className="text-sm font-medium text-stone-700">Brand ID</span>
          <input
            type="text"
            value={v.brandId}
