...
export function ConnectionStatus({ companyName }: { companyName: string }) {
  return (
    <div className="flex items-center justify-between rounded-lg bg-white px-4 py-2 text-xs ring-1 ring-stone-200">
      <span className="inline-flex items-center gap-1.5 text-stone-600">
        <CheckCircle2 className="h-3.5 w-3.5 text-emerald-600" aria-hidden />
        Connected to <span className="font-semibold text-stone-900">{companyName}</span>
      </span>
