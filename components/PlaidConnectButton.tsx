  ...
  return (
    <div>
      <button
        ...
        onClick={connect}
        disabled={busy}
        className="group inline-flex items-center gap-2 rounded-full bg-stone-900 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-stone-800 hover:shadow-md disabled:opacity-50"
      >
        {busy ? (
