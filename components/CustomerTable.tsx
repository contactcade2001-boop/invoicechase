        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stone-800 bg-gradient-to-r from-orange-50 to-amber-50 px-5 py-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              onClick={bulkText}
              disabled={pending}
              className="inline-flex items-center gap-1.5 rounded-md bg-orange-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-orange-700 disabled:opacity-50"
            >
